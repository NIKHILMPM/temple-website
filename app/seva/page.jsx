        ...
        <>
            ...
            <div className="hidden md:block ">
                {displayState && <div className="fixed inset-0 z-40 w-screen h-screen bg-black/50 flex justify-center items-center" onClick={() => setDisplayState(false)}>
                    <div className="w-1/2 h-1/2 bg-amber-50 rounded-xl shadow-md p-4 flex items-center justify-center z-50">
                                                    ...
                                                    <tbody>
                                                        {sevaGroup.items.map((item) => (
                                                            <tr key={item.sr} className="h-12">
                                                                ...
                                                                <td className="px-2 py-1 text-center align-middle h-12 truncate">{item.seva}</td>
            ...
            <div className="block md:hidden">
                {displayState && <div className="fixed inset-0 z-40 w-screen h-screen bg-black/50 flex justify-center items-center" onClick={() => setDisplayState(false)}>
                    <div className="w-full h-1/2 bg-amber-50 rounded-xl shadow-md p-4 flex items-center justify-center z-50">
                        <div className=" overflow-x-auto w-full h-full">
                            <table className="w-full text-sm md:text-base text-gray-700">
                                <thead>
                                    <tr className="bg-gradient-to-r from-amber-100 to-yellow-100 text-gray-800 rounded-t-lg">
                    ...
                    <div className="h-[90%] w-[90%] bg-black/20 mb-7 text-white flex justify-around items-center bg-opacity-90 rounded-xl overflow-hidden shadow-lg">
                        <div className="h-[85%] w-full mb-10">
                            ...
                            >
                                {sevasList.map((sevaGroup, index) => (
                                    <SwiperSlide key={index}>
                                        <div className="h-full w-full backdrop-blur-xs font-bold font-serif rounded-lg p-6 overflow-y-auto flex flex-col justify center items-center">
                                            <div className="h-[20%] w-full flex justify-center items-center">
                                                <h2 className="text-3xl font-bold mb-4 text-center">{sevaGroup.title}</h2>
                                            </div>
                                            <div className="h-[60%] w-full flex justify-start items-start overflow-y-auto">
                                                <table className="w-full text-[20%] md:text-base table-fixed border-collapse">
                                                    <thead>
                                                        <tr className="h-12 ">
                                                            <th className="px-2 py-1 text-center">SR</th>
                                                            <th className="px-2 py-1 text-center">SEVA</th>
